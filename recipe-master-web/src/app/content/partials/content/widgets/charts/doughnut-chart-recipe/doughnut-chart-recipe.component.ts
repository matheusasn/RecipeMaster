...
@Component({
  selector: 'm-doughnut-chart-recipe',
  templateUrl: './doughnut-chart-recipe.component.html',
  styleUrls: ['./doughnut-chart-recipe.component.scss']
})
export class DoughnutChartRecipeComponent implements OnInit, AfterViewInit {
